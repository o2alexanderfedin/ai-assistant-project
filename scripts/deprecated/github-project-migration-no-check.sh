#!/bin/bash
# GitHub Project Migration Script (No Auth Check Version)
# Assumes you've already run: gh auth refresh -h github.com -s project
# Created: $(date +%Y-%m-%d)
...
PROJECT_ID=$(gh projects create --user '@me' --title "AI Assistant Development" \
