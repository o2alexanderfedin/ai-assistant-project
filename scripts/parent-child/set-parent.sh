...
# Usage: ./set-direct-parent-improved.sh <parent_issue_number> <child_issue_number>
...
# Set the parent-child relationship using addSubIssue mutation with required header
echo "Setting parent relationship with sub_issues feature enabled..."
